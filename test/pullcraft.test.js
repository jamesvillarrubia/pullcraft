...
async function testErrorHandling(fn, expectedErrorMessage, consoleErrorStub) {
    try {
        await fn();
...
describe('PullCraft', () => {
    ...
    describe('getNewFiles', () => {
        it('should get new files', async () => {
            ...
            expect(result).to.equal('diff --git a/file1.txt b/file1.txt\n...diff --git a/file2.txt b/file2.txt\n...');
        });
...
//# sourceMappingURL=pullcraft.test.js.map